    ...
    def _prep_wrapped_messages(self):
        ...
        self._wrapped_methods = {
            ...
            self.create_cluster: gapic_v1.method.wrap_method(
                self.create_cluster, default_timeout=45.0, client_info=_client_info,
            ),
            self.update_cluster: gapic_v1.method.wrap_method(
                self.update_cluster, default_timeout=45.0, client_info=_client_info,
            ),
            self.update_node_pool: gapic_v1.method.wrap_method(
                self.update_node_pool, default_timeout=45.0, client_info=_client_info,
            ),
            ...
            self.set_addons_config: gapic_v1.method.wrap_method(
                self.set_addons_config, default_timeout=45.0, client_info=_client_info,
            ),
            self.set_locations: gapic_v1.method.wrap_method(
                self.set_locations, default_timeout=45.0, client_info=_client_info,
            ),
            self.update_master: gapic_v1.method.wrap_method(
                self.update_master, default_timeout=45.0, client_info=_client_info,
            ),
            self.set_master_auth: gapic_v1.method.wrap_method(
                self.set_master_auth, default_timeout=45.0, client_info=_client_info,
            ),
            ...
            self.cancel_operation: gapic_v1.method.wrap_method(
                self.cancel_operation, default_timeout=45.0, client_info=_client_info,
            ),
            ...
            self.create_node_pool: gapic_v1.method.wrap_method(
                self.create_node_pool, default_timeout=45.0, client_info=_client_info,
            ),
            ...
            self.set_labels: gapic_v1.method.wrap_method(
                self.set_labels, default_timeout=45.0, client_info=_client_info,
            ),
            self.set_legacy_abac: gapic_v1.method.wrap_method(
                self.set_legacy_abac, default_timeout=45.0, client_info=_client_info,
            ),
            self.start_ip_rotation: gapic_v1.method.wrap_method(
                self.start_ip_rotation, default_timeout=45.0, client_info=_client_info,
            ),
            ...
            self.set_node_pool_size: gapic_v1.method.wrap_method(
                self.set_node_pool_size, default_timeout=45.0, client_info=_client_info,
            ),
            self.set_network_policy: gapic_v1.method.wrap_method(
                self.set_network_policy, default_timeout=45.0, client_info=_client_info,
            ),

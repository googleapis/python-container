...
def test_get_open_id_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_open_id_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_get_open_id_config_async(transport: str = 'grpc_asyncio', request_type=cluster_service.GetOpenIDConfigRequest):
    client = ClusterManagerAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(cluster_service.GetOpenIDConfigResponse(
            issuer='issuer_value',
            jwks_uri='jwks_uri_value',
            response_types_supported=['response_types_supported_value'],
            subject_types_supported=['subject_types_supported_value'],

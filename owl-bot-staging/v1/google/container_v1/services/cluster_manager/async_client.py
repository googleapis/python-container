    ...
    async def create_cluster(self,
        ...
        Args:
            ...
            zone (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            cluster (:class:`google.container_v1.types.Cluster`):
                Required. A `cluster
    ...
    async def update_cluster(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            update (:class:`google.container_v1.types.ClusterUpdate`):
    ...
    async def set_addons_config(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            addons_config (:class:`google.container_v1.types.AddonsConfig`):
    ...
    async def create_node_pool(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            node_pool (:class:`google.container_v1.types.NodePool`):
...
initial=0.1,maximum=60.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def set_network_policy(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            network_policy (:class:`google.container_v1.types.NetworkPolicy`):
    ...
    async def set_maintenance_policy(self,
        ...
        Args:
            ...
            cluster_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            maintenance_policy (:class:`google.container_v1.types.MaintenancePolicy`):
    ...
    async def list_usable_subnetworks(self,
        ...
        Returns:
            google.container_v1.services.cluster_manager.pagers.ListUsableSubnetworksAsyncPager:
